...
/*
 * ALTERACAO--------------------------------------------------------------------------
 * Tendo em conta que BST e apenas usada neste projeto com App* e não e possivel fazer
 * overload do operador < para o apontador, foi necessario substituir por uma funcao
 * definida em appStore.cpp que comparasse as App's em si em vez dos seus apontadores
 * definida da seguinte maneira:
 * --------------------------------------------
bool menorQue(App*a, App*b) {
	return (*a < *b);
}
 * --------------------------------------------
 * Desta forma a comparacao é efetuada de forma correta
 */
template <class Comparable>
void BST<Comparable>::
